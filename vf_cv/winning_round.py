...
class WinningRound:
    ...
    def is_winning_round(self, debug=False):
        ...
        if (self.frame_height == 480 and (all_dark_blue >= 5 or all_dark_red >= 5 or all_dark_maroon >= 10 or other_maroon > 80 or other_db > 80 or other_blue > 25 or another_blue >= 15 or bar_blue >= 10 or more_blue > 7)):
            #print ("arbot a")
            return 0
