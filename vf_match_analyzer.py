...
def extract_frames(
    ...
    while count < end_frame or cam != -1:
        ...
        if state == "vs":
            if match.player1character is None:
            ...
            if match.player2character is None:
                character.set_frame(frame)
            ...
            if match.player1ringname is None:
            ...
            if match.player2ringname is None:
