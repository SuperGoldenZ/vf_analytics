...
def test_get_player_rank(
    ...
    rank=player_rank.get_player_rank(1)
    assert expected_player_1_rank == rank, f"Failed for {image_filename} player 1 expected {expected_player_1_rank} but got {rank}"

    rank=player_rank.get_player_rank(2)
    assert expected_player_2_rank == rank, f"Failed for {image_filename} player 2 expected {expected_player_2_rank} but got {rank}"
